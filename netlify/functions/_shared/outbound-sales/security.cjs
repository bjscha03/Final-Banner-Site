...
const PUBLIC_ERROR_CODES = new Set([
  ...
  'INVALID_MANUAL_ARTWORK',
  'MANUAL_ARTWORK_TOO_LARGE',
  'MANUAL_ARTWORK_TOO_SMALL',
  'MANUAL_ARTWORK_PROCESSING_UNAVAILABLE',
  'MANUAL_ARTWORK_STORAGE_FAILED',
  'MANUAL_ARTWORK_NOT_FOUND',
  'MANUAL_ARTWORK_NOT_READY',
  'MANUAL_ARTWORK_MESSAGE_REQUIRED',
...
function safeFailure(error) {
  ...
  const statusByCode = {
    ...
    INVALID_MANUAL_ARTWORK: 400,
    MANUAL_ARTWORK_TOO_LARGE: 413,
    MANUAL_ARTWORK_TOO_SMALL: 400,
    MANUAL_ARTWORK_PROCESSING_UNAVAILABLE: 503,
    MANUAL_ARTWORK_STORAGE_FAILED: 503,
    MANUAL_ARTWORK_NOT_FOUND: 404,
    MANUAL_ARTWORK_NOT_READY: 409,
    MANUAL_ARTWORK_MESSAGE_REQUIRED: 409,
  ...
  const messages = {
    ...
    INVALID_MANUAL_ARTWORK: 'Choose a valid high-resolution PNG, JPG, or WebP banner image.',
    MANUAL_ARTWORK_TOO_LARGE: 'The image is too large for this secure upload. Export a high-quality JPG under 4 MB and try again.',
    MANUAL_ARTWORK_TOO_SMALL: 'The image is too small for a sharp email preview. Use an image at least 900×500 pixels.',
    MANUAL_ARTWORK_PROCESSING_UNAVAILABLE: 'Image processing is temporarily unavailable on this deploy.',
    MANUAL_ARTWORK_STORAGE_FAILED: 'The uploaded image could not be stored and verified safely. Nothing was changed.',
    MANUAL_ARTWORK_NOT_FOUND: 'This lead could not be found for a banner upload.',
    MANUAL_ARTWORK_NOT_READY: 'Upload and review a banner image for this company before sending.',
    MANUAL_ARTWORK_MESSAGE_REQUIRED: 'Generate the current email draft before uploading its banner image.',
