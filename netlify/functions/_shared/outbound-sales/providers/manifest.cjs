...
// Metadata only. Phase 1 intentionally installs no discovery implementation.
...
const PROVIDER_MANIFEST = Object.freeze([
  ...
  Object.freeze({ id: 'apollo', displayName: 'Apollo', kind: 'discovery', acquisitionMode: 'licensed_api', secretEnvName: 'OUTBOUND_APOLLO_API_KEY', adapterInstalled: false }),
