          ...
          try {
            await sql`
              INSERT INTO order_items (
                ...
                line_total_cents, file_key, file_url, print_ready_url, web_preview_url, text_elements, overlay_image, overlay_images, canvas_background_color, image_scale, image_position
              )
              VALUES (
                ${randomUUID()},
                ${orderId},
