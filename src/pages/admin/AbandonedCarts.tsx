    ...
    <Layout>
      ...
      <main className="container mx-auto px-4 py-6 sm:py-8">
        ...
        <div className="mt-6 text-sm text-gray-600">
          Breakdown based on all <strong>{matchingAnalytics.totalCount}</strong> matching cart{matchingAnalytics.totalCount === 1 ? '' : 's'}, across every results page. Size, material, and product facets use captured snapshot lines; omitted or historically unverifiable source lines cannot contribute. Value and checkout-stage bands remain cart-level.
        </div>
