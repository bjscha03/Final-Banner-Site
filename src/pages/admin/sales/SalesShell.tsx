          ...
          <div className="mx-auto flex max-w-[1600px] flex-wrap items-center justify-between gap-4">
            <div>
              <div className="flex flex-wrap items-center gap-2">
                ...
                {modeBadge(status)}
                <Badge className="border-white/20 bg-white/10 text-white">Production-ready · Shadow locked</Badge>
              </div>
              <h1 className="mt-2 text-2xl font-black sm:text-3xl">Outbound Sales Command Center</h1>
              <p className="mt-1 max-w-3xl text-sm text-slate-300">
                Monitor discovery, qualification, personalized previews, replies, pipeline, revenue, experiments, cost, and safety from one isolated workspace.
              </p>
            </div>
