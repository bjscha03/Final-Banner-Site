...
export default function SalesReplies() {
  ...
  return <div className="space-y-6">
    ...
    {!loading && data?.schemaReady && !data.replies.length && <div className="rounded-2xl border border-slate-200 bg-white p-12 text-center"><Inbox className="mx-auto h-8 w-8 text-slate-400" /><h3 className="mt-3 font-black">No replies in this view</h3><p className="mt-1 text-sm text-slate-500">The inbox is ready and automatic reply sending remains unavailable.</p></div>}
