                      ...
                      {!showEditForm && (
                        <div className="mt-6 grid sm:grid-cols-2 gap-3">
                          <Button
                            ...
                            className="bg-[#C94E00] hover:bg-[#B84300] text-white hover:text-white font-bold py-6 text-base"
                          >
                            {approving ? (
                              <>
                        ...
                        <div className="mt-5 rounded-2xl bg-white p-6 shadow-sm border border-gray-200">
                          ...
                          <div className="flex gap-3 mt-4">
                            <Button
                              ...
                              className="bg-[#C94E00] hover:bg-[#B84300] text-white hover:text-white font-bold"
                            >
                              {requestingEdits ? (
                                <>
