...
const FAQS: { q: string; a: string }[] = [
  {
    q: 'Can I upload my own campaign design?',
...
const INTAKE_STORAGE_KEY = 'political_intake_draft';
...
const PoliticalSigns: React.FC = () => {
  ...
  const navigateToBuilder = (product: ProductType) => {
    navigate(`/design?product=${PRODUCT_QUERY_SLUG[product]}&theme=political`);
        ...
        <div className="relative z-[2] max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-24 lg:py-32">
          <div className="max-w-xl lg:max-w-lg">
            <div className="inline-flex items-center gap-2 rounded-full bg-white/10 backdrop-blur px-4 py-1.5 text-sm font-semibold mb-6 ring-1 ring-white/20">
              <GraduationCap className="h-4 w-4 text-[#FF6A00]" /> POLITICAL CAMPAIGN SIGNS
            </div>
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tight leading-tight text-white">
              Custom <span className="text-[#FF6A00]">Campaign Signs & Banners</span> Made Easy
            </h1>
            <p className="mt-5 text-lg md:text-xl text-white/90">
              24-hour production, free next-day air shipping, and durable political signage built to help your campaign get noticed.
            </p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="mt-3 text-gray-600 max-w-2xl mx-auto">
              ...
              campaign. Either way, we print and ship fast.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 items-stretch">
            ...
            >
              ...
              <p className="text-gray-600">
                Already have a campaign design? Upload your artwork, choose your product, and check
            ...
            >
              ...
              <p className="text-gray-600">
                Tell us about your campaign and we’ll create a custom proof for approval.
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {flow === 'designer' && (
            ...
            <form onSubmit={handleIntakeSubmit} className="space-y-10">
              ...
              {/* Graduate */}
              <fieldset className="space-y-4">
                <legend className="text-xl font-bold text-[#0B1F3A]">About your campaign</legend>
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <Field
                    ...
                    onChange={(v) => setGraduate({ ...campaign, campaignYear: v })}
                  />
                  <Field
                  ...
                  <Field
                    ...
                    onChange={(v) => setGraduate({ ...campaign, campaignDate: v })}
                  />
                  <Field
                    label="Campaign event date (optional)"
                    type="date"
                    value={campaign.partyDate}
                    onChange={(v) => setGraduate({ ...campaign, partyDate: v })}
                  />
                </div>
              </fieldset>
