            ...
            <form onSubmit={handleIntakeSubmit} className="space-y-10">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-2">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="inline-flex items-center gap-2 rounded-lg bg-[#C94E00] hover:bg-[#B84300] disabled:opacity-60 text-white font-bold px-8 py-3 text-lg shadow-md transition"
                >
                  {submitting ? (
                    <>
