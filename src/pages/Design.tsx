...
const Design: React.FC = () => {
  ...
  const [showHalloweenTutorial, setShowHalloweenTutorial] = useState(false);
  ...
  // Check if coming from Halloween route
  useEffect(() => {
    if (location.pathname === '/halloween-banner') {
      setShowHalloweenTutorial(true);
    }
  }, [location.pathname]);
