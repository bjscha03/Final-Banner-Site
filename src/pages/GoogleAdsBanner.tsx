          ...
          {NEW_BUILDER_ACTIVE ? (
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-[minmax(0,1fr)_420px] xl:grid-cols-[minmax(0,1fr)_460px] gap-6 xl:gap-8 max-w-full">
              <div className="space-y-6 min-w-0 max-w-full">
                ...
                {!NEW_BUILDER_ACTIVE && <ConfigCard step={2} title="Select material" id="material-section">
                ...
                {!isYardSign && (
                  <>
                {!NEW_BUILDER_ACTIVE && <ConfigCard step={3} title="Quantity" id="quantity-section">
                ...
                {!NEW_BUILDER_ACTIVE && <ConfigCard step={4} title={isCarMagnet ? 'Rounded Corners' : 'Finishing options'} id="options-section">
