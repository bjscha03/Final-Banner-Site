...
const AddToCartButton: React.FC<AddToCartButtonProps> = ({ 
  ...
  const handleClick = () => {
    ...
    console.log('🔍 DETAILED baseTotals breakdown:');
    console.log('  - baseTotals.unit:', baseTotals.unit);
    console.log('  - baseTotals.rope:', baseTotals.rope);
    console.log('  - baseTotals.polePocket:', baseTotals.polePocket);
    console.log('  - baseTotals.materialTotal:', baseTotals.materialTotal);
    
    console.log('🔍 Pole pocket calculation check:');
    console.log('  - quote.polePockets value:', quote.polePockets);
    console.log('  - Is it "none"?', quote.polePockets === 'none');
    console.log('  - baseTotals.polePocket (dollars):', baseTotals.polePocket);
    console.log('  - Will convert to cents:', Math.round(baseTotals.polePocket * 100));
