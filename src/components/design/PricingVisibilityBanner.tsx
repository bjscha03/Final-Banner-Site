    ...
    <div className="mb-6 border-l-4 border-[#FF6A00] bg-white p-4 shadow-[0_8px_24px_rgba(11,31,58,0.05)] md:p-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-slate-600">13oz banners use progressive volume pricing. Options and quantity update the total.</p>
        </div>
      </div>
      <div className="mt-4 border-t border-slate-200 pt-4">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-sm">
          <div className="flex items-center gap-2"><div className="h-2 w-2 bg-[#FF6A00]"></div><span className="text-slate-700">13oz Vinyl: <span className="font-semibold">$5.00 first 20 sq ft, then lower volume rates</span></span></div>
