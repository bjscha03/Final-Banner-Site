...
const BannerEditorLayout: React.FC<BannerEditorLayoutProps> = ({ onOpenAIModal, designServiceMode: externalDesignServiceMode, onDesignServiceModeChange }) => {
  ...
  return (
    ...
    <div className="flex h-[calc(100dvh-145px)] flex-col bg-[#F7F7F7] lg:h-screen">


      {/* Professional Header */}
      <div className={`bg-white border-b border-gray-200 shadow-sm z-20 ${activePanel ? "lg:block hidden" : ""}`}>
      ...
      <div className="flex-1 flex overflow-hidden relative isolate">
        ...
        {!designServiceMode && activePanel && activePanelData && (
          <>
            ...
            <div
              ref={mobilePanelRef}
              className="lg:hidden fixed inset-x-0 bottom-0 bg-white rounded-t-2xl shadow-2xl z-[110]"
              style={{
                height: '75vh',
                maxHeight: '75vh',
