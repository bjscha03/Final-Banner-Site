...
const PreviewCanvas: React.FC<PreviewCanvasProps> = ({
  ...
  // Debug logging
  console.log('🎯 PreviewCanvas Print Guidelines Debug:', {
    showDimensions,
    showSafetyArea,
    showBleedArea,
    totalWidth,
  ...
  // Professional print guidelines constants
  const BLEED_SIZE = 0.125; // 0.125" bleed area
  const SAFETY_MARGIN = 0.5; // 0.5" safety area
  const RULER_HEIGHT = 0.3; // Height of dimension rulers
