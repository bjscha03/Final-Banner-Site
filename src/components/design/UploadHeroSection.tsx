    ...
    <div className="mb-8 border-2 border-dashed border-slate-300 bg-white p-8 transition-colors hover:border-[#FF6A00] md:p-12">
      <div className="text-center max-w-2xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
          <Button type="button" size="lg" className="bg-[#C94E00] px-8 py-6 text-lg text-white hover:bg-[#B84300] hover:text-white" onClick={handleUploadClick} disabled={isUploading}>
            {isUploading ? (
              <>
