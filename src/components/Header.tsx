  ...
  return (
    <header
      ...
      className={isHomepage
        ...
        : 'sticky top-0 z-50 border-b border-slate-200 bg-white/95 shadow-[0_4px_20px_rgba(11,31,58,0.04)] backdrop-blur'}
    >
      {!isHomepage && <div className="h-1 bg-[#FF6A00]" />}
      <div className={isHomepage ? 'mx-auto max-w-[1740px] px-4 sm:px-6 lg:px-8' : 'mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'}>
        <div className={isHomepage ? 'flex h-[72px] items-center justify-between lg:h-[92px]' : 'flex h-[72px] items-center justify-between lg:h-[78px]'}>
          ...
          <div className="flex items-center w-12 lg:hidden" ref={menuRef}>
            <button
              ...
              className={`min-h-11 min-w-11 rounded-md p-2 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF6A00] ${isHomepage ? 'text-white hover:bg-white/10' : 'text-[#0B1F3A] hover:bg-slate-100'}`}
          ...
          <div className="flex-shrink-0">
            <ScrollToTopLink to="/" className="flex items-center">
              <img
                src={isHomepage ? '/images/homepage/header-logo-reverse.png' : '/images/header-logo.png'}
                alt="Banners On The Fly"
                width="248"
                height="70"
                className={isHomepage ? 'h-10 w-auto max-w-[205px] object-contain sm:h-12 sm:max-w-[260px] lg:h-[58px]' : 'h-10 w-auto max-w-[205px] object-contain sm:h-12 sm:max-w-[250px]'}
              />
            </ScrollToTopLink>
          </div>
            ...
            {[
              ...
              <ScrollToTopLink
                ...
                className={`relative py-2 text-sm font-semibold transition-colors after:absolute after:inset-x-0 after:-bottom-1 after:h-0.5 after:origin-left after:bg-[#FF6A00] after:transition-transform focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF6A00] ${
                  location.pathname === item.href
                    ? `${isHomepage ? 'text-white' : 'text-[#0B1F3A]'} after:scale-x-100`
                    : `${isHomepage ? 'text-white/90 hover:text-white' : 'text-slate-600 hover:text-[#0B1F3A]'} after:scale-x-0 hover:after:scale-x-100`
                }`}
              >
                {item.name}
              </ScrollToTopLink>
          ...
          <div className="flex items-center justify-end gap-1 lg:w-auto lg:gap-2">
            ...
            {!loading && (
              ...
              >
                <DropdownMenuTrigger asChild>
                  <button
                    className={`min-h-11 min-w-11 rounded-md p-2 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF6A00] ${isHomepage ? 'text-white hover:bg-white/10' : 'text-slate-500 hover:bg-slate-100 hover:text-[#0B1F3A]'}`}
                    aria-label="Account"
                  >
            ...
            <button
              ...
              className={`relative min-h-11 min-w-11 rounded-md p-2 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF6A00] ${isHomepage ? 'text-white hover:bg-white/10' : 'text-[#0B1F3A] hover:bg-slate-100'}`}
            >
