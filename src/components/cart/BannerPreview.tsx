      ...
      >
        ...
        >
          ...
          {textElements.map((textEl) => {
            // FIXED: Match the live preview text size
            // The fontSize is stored in pixels (e.g., 48px)
            // The live preview renders text at: fontSize * (previewScale / 100) pixels
            // At 100% scale, a 48px font on a ~400px tall banner preview = 12% of height
            // In the thumbnail SVG, we need the same 12% of banner height in inches
            // Formula: (fontSize / estimated_preview_height_px) * banner_height_inches
