            ...
            <div className="flex items-start gap-2">
              ...
              <div className="space-y-2">
                <p className="text-sm font-semibold text-amber-900">
                  Important: This check only validates pixel dimensions and DPI calculations
                </p>
                <p className="text-sm text-amber-800">
                  This tool does <strong>NOT</strong> analyze actual image quality such as:
                </p>
                <ul className="text-sm text-amber-800 list-disc list-inside space-y-1 ml-2">
                  <li>Image sharpness or blur</li>
                  <li>Grain, noise, or compression artifacts</li>
                  <li>Color accuracy or vibrancy</li>
                  <li>Source image quality</li>
                </ul>
                <p className="text-sm text-amber-800 mt-2">
                  An image with sufficient pixels may still print poorly if the source is blurry, grainy, or low quality. 
                  Always visually inspect your images before ordering.
                </p>
              </div>
            </div>
          </div>
