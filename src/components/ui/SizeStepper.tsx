      ...
      <div className="grid grid-cols-[auto_1fr_auto] gap-2 items-center">
        ...
        <div className="relative">
          <input
            ...
            inputMode="numeric"
            pattern="[0-9]*"
            className="h-12 w-full rounded-lg border border-gray-300 text-center font-medium tabular-nums text-gray-900 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors duration-200"
            value={value || ''}
