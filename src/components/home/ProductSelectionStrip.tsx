  ...
  <section className="brand-section bg-white" aria-labelledby="product-selection-heading">
    <div className="brand-shell">
      <div className="max-w-3xl">
        ...
        <p className="brand-copy mt-4">Each product has its own sizes, materials, and finishing choices—so you can compare the facts before opening the design tool.</p>
      </div>
          ...
          <article key={product.slug} className="group overflow-hidden border border-slate-200 bg-white transition-colors hover:border-[#0B1F3A]">
            ...
            <div className="p-6 sm:p-7">
              <div className="flex items-baseline justify-between gap-4">
                ...
                <p className="whitespace-nowrap font-display text-lg font-bold text-[#D95700]">{product.price}</p>
              </div>
              ...
              <div className="mt-5 flex items-center justify-between gap-4">
                <Link to={`/${product.slug}`} className="inline-flex items-center gap-2 font-bold text-[#0B1F3A] underline decoration-[#FF6A00] decoration-2 underline-offset-4 hover:text-[#D95700]">
