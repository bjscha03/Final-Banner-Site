...
const HeroSection: React.FC = () => {
  ...
  return (
    ...
    >
      {isSeasonal && artwork ? (
        <picture
          data-seasonal-hero-art
          className="absolute inset-y-0 -right-[24%] z-0 w-full sm:right-0 sm:w-[84%] lg:w-[73%]"
        >
          {artwork.mobileAvifSrc ? (
            <source media="(max-width: 639px)" type="image/avif" srcSet={artwork.mobileAvifSrc} />
          ) : null}
          <source media="(max-width: 639px)" type="image/webp" srcSet={artwork.mobileSrc} />
